...
class SiteForm(forms.ModelForm):
    class Meta:
        ...
        fields = (
            ...
            "pre_chat_enabled", "transcript_enabled", "feedback_enabled",
        ...
        labels = {
            ...
            "feedback_enabled": "Post-chat rating",
        ...
        help_texts = {
            ...
            "feedback_enabled": "Ask visitors to rate the chat (1–5 stars) after an operator ends it.",
